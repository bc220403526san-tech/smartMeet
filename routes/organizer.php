...
Route::middleware(['auth', 'role:organizer'])
    ...
    ->group(function () {
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            Route::patch('/profile', [\App\Http\Controllers\Organizer\SettingsController::class, 'updateProfile'])->name('profile.update');
            Route::post('/avatar', [\App\Http\Controllers\Organizer\SettingsController::class, 'updateAvatar'])->name('avatar.update');
            Route::put('/password', [\App\Http\Controllers\Organizer\SettingsController::class, 'updatePassword'])->name('password.update');
            Route::patch('/notifications', [\App\Http\Controllers\Organizer\SettingsController::class, 'updateNotifications'])->name('notifications.update');
            Route::delete('/deactivate', [\App\Http\Controllers\Organizer\SettingsController::class, 'deactivate'])->name('deactivate');
            Route::post('/flash', [\App\Http\Controllers\Organizer\SettingsController::class, 'storeFlash'])->name('flash');
            Route::post('/role-request', [App\Http\Controllers\Organizer\SettingsController::class, 'roleRequest'])->name('role-request');
        });
        ...
        Route::prefix('meetings')->name('meetings.')->group(function () {
            ...
            Route::post('/{meeting}/moderate', [MeetingModerationController::class, 'moderate'])->name('moderate');
        });
    });
