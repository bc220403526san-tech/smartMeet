<x-layouts.app>
    ...
    <!-- CONTENT -->
    <div class="p-6 bg-gray-50 mt-3 rounded-lg flex-1 overflow-y-auto">

        <!-- Title -->
        <div class="mb-6">
            <h1 class="text-2xl font-semibold">Profile</h1>
            <p class="text-gray-400 text-sm">View and edit your profile information securely.</p>
        </div>

        <!-- TWO COLUMN LAYOUT -->
        <div class="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">

            <!-- LEFT: IDENTITY CARD -->
            <div class="lg:col-span-1 bg-white rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition overflow-hidden">

                <!-- Blue Header Banner -->
                <div class="bg-gradient-to-br from-blue-600 to-blue-400 h-28 relative">
                    <!-- Decorative circles -->
                ...
                <div class="flex flex-col items-center -mt-16 px-6 pb-6">
                    ...
                    <div class="relative group mb-4">
                        ...
                        <label class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center rounded-2xl cursor-pointer transition">
                    ...
                    <!-- Name & Role -->
                    <h2 class="text-lg font-bold text-gray-800 text-center">Alex Thompson</h2>
                    <p class="text-sm text-gray-400 text-center mb-3">alex.thompson@smartmeet.ai</p>

                    <span class="bg-blue-100 text-blue-600 text-xs font-semibold px-4 py-1.5 rounded-full tracking-wide mb-6">
                        SYSTEM ADMINISTRATOR
                    </span>

                    <!-- Stats -->
                    <div class="w-full bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl px-6 py-4 text-center border border-blue-100">
                    ...
                    <div class="w-full space-y-3">
                        ...
                        <div class="flex items-center gap-3 text-sm text-gray-600">
                            ...
                            <span>Eastern Time (UTC−05:00)</span>
                        </div>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition">
                ...
                <div class="flex items-center justify-between px-8 py-5 border-b border-gray-100">
                    ...
                    <div class="flex items-center gap-3">
                        <button class="text-sm text-gray-400 hover:text-gray-600 transition font-medium px-4 py-2 rounded-lg hover:bg-gray-100">
                            Discard
                        </button>
                        <button class="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-sm px-5 py-2.5 rounded-xl shadow-sm transition font-medium">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" value="Alex Thompson"
                                       class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 focus:bg-white transition">
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-blue-400 focus:bg-white transition appearance-none">
