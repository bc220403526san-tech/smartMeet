            ...
            <div class="overflow-x-auto">
                <table class="min-w-[1180px] w-full text-sm">
                    ...
                    <tr class="bg-blue-100 border-b border-blue-200">
                        <th class="px-6 py-5 text-left text-[11px] font-semibold text-blue-800 uppercase tracking-wider">
                            Participant
                        </th>
                        <th class="px-5 py-5 text-left text-[11px] font-semibold text-blue-800 uppercase tracking-wider">
                            Meeting
                        </th>
                        <th class="px-5 py-5 text-left text-[11px] font-semibold text-blue-800 uppercase tracking-wider">
                            Public IP
