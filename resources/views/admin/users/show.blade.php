        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
                <a href="{{ route('admin.users.index') }}"
                   class="inline-flex items-center gap-1 mb-1 text-sm font-medium text-blue-600 hover:gap-2 transition-all">
            ...
            <div class="px-5 sm:px-8 py-6 sm:py-7 bg-gradient-to-r from-blue-50 to-indigo-50">
                <div class="flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-6">
                    ...
                    <div class="min-w-0 flex-1 text-center sm:text-left">
                        ...
                        <div class="mt-3 flex flex-col lg:flex-row lg:items-center gap-2 lg:gap-5 text-sm text-gray-500">
                    ...
                    <div class="shrink-0 self-center sm:self-auto">
                        <span class="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-sm font-semibold bg-white border border-gray-200 shadow-sm">
            ...
            <div class="px-5 sm:px-8 py-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    <div class="flex items-center gap-3 p-4 bg-gray-50 border border-gray-100 rounded-2xl">
                        <div class="flex items-center justify-center w-9 h-9 rounded-xl bg-blue-100 text-blue-600 shrink-0">
                    ...
                    <div class="flex items-center gap-3 p-4 bg-gray-50 border border-gray-100 rounded-2xl">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 font-semibold text-gray-800">{{ $user->created_at->format('M d, Y') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 p-4 bg-gray-50 border border-gray-100 rounded-2xl">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 font-semibold text-gray-800">{{ $user->is_active ? 'Active' : 'Inactive' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 p-4 bg-gray-50 border border-gray-100 rounded-2xl">
                        ...
                        <div>
                            ...
                            <p class="mt-0.5 font-semibold text-gray-800">{{ $user->updated_at->format('M d, Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            @if(in_array($user->role, ['organizer', 'participant'], true))
                <div class="px-5 sm:px-8 py-6 border-t border-gray-100">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4
                                p-4 sm:p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center justify-center w-11 h-11 rounded-xl bg-white text-blue-600 shadow-sm shrink-0">
                        ...
                        <a href="{{ route('admin.users.meetings', $user) }}"
                           class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl
                                  bg-blue-600 text-white text-sm font-semibold shadow-sm hover:bg-blue-700 transition">
            ...
            @if(auth()->id() !== $user->id)
                <div class="px-5 sm:px-8 py-5 border-t border-gray-100 bg-gray-50/50">
                    <form action="{{ route('admin.users.destroy', $user) }}"
                        ...
                        <button type="submit"
                                class="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2.5
                                       text-sm font-medium text-red-500 border border-red-200 rounded-xl hover:bg-red-50 transition">
