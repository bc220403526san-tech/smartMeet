<x-layouts.app>
    ...
    <div class="p-4 bg-gray-50 rounded-2xl m-2 mt-0 space-y-4 overflow-y-auto min-h-screen">
        ...
        @if(session()->pull('organizer_welcome_banner', false) || session('show_welcome_banner'))
            <x-banner
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
            ...
            <div class="bg-white/80 backdrop-blur-md p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                <div class="flex items-start justify-between">
                    ...
                    <p class="text-xs text-blue-500 font-semibold tracking-widest">
                        TOTAL
                    </p>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-md p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                <div class="flex items-start justify-between">
                    ...
                    <p class="text-xs text-green-500 font-semibold tracking-widest">
                        LIVE
                    </p>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-md p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                <div class="flex items-start justify-between">
                    ...
                    <p class="text-xs text-indigo-500 font-semibold tracking-widest">
                        TODAY
                    </p>
                </div>
            ...
            <div class="bg-white/80 backdrop-blur-md p-4 sm:p-5 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
                <div class="flex items-start justify-between">
                    ...
                    <p class="text-xs text-orange-500 font-semibold tracking-widest">
                        UPCOMING
                    </p>
                </div>
