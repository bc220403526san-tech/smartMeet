...
<div class="p-4 bg-gray-50 rounded-2xl m-2 mt-0 space-y-6 overflow-y-auto min-h-screen">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="group bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition duration-200">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-[11px] font-semibold text-gray-400 tracking-[0.14em]">TOTAL INVITED</p>
                    <h2 id="stat-total" class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['total'] }}</h2>
                </div>
                <div class="w-11 h-11 bg-blue-50 rounded-2xl flex items-center justify-center shrink-0 ring-1 ring-blue-100">
        ...
        <div class="group bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition duration-200">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-[11px] font-semibold text-gray-400 tracking-[0.14em]">ACTIVE NOW</p>
                    <h2 class="text-3xl font-bold text-gray-900 mt-2 flex items-center gap-2">
                ...
                <div class="w-11 h-11 bg-amber-50 rounded-2xl flex items-center justify-center shrink-0 ring-1 ring-amber-100">
        ...
        <div class="group bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition duration-200">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-[11px] font-semibold text-gray-400 tracking-[0.14em]">PENDING INVITES</p>
                    <h2 id="stat-pending" class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['pending'] }}</h2>
                </div>
                <div class="w-11 h-11 bg-purple-50 rounded-2xl flex items-center justify-center shrink-0 ring-1 ring-purple-100">
