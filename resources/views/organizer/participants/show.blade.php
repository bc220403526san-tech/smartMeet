...
<div class="p-4 bg-gray-50 rounded-2xl m-2 mt-0 space-y-6 overflow-y-auto min-h-screen">
    ...
    <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
        {{-- PROFILE --}}
        <section class="rounded-2xl bg-white p-6 shadow-sm xl:col-span-1">
            @php
        ...
        {{-- MEETING HISTORY --}}
        <section class="rounded-2xl bg-white p-5 shadow-sm sm:p-6 xl:col-span-2">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                ...
                @forelse($participant->joinedMeetings->take(10) as $record)
                    ...
                    <div class="rounded-2xl border border-gray-100 bg-gray-50 p-4 sm:p-5">
                        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <div class="grid w-full grid-cols-1 gap-3 sm:grid-cols-3 lg:w-auto lg:min-w-[520px]">
