...
<div class="p-4 bg-gray-50 rounded-2xl m-2 mt-0 space-y-6 overflow-y-auto min-h-screen">
    ...
    <div class="grid grid-cols-1 gap-7 xl:grid-cols-3">
        {{-- PROFILE --}}
        <section class="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm xl:col-span-1">
            @php
        ...
        {{-- MEETING HISTORY --}}
        <section class="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm sm:p-6 xl:col-span-2">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
            ...
            <div class="mt-6 max-h-[560px] space-y-5 overflow-y-auto pr-3">
                @forelse($participant->joinedMeetings->take(10) as $record)
                    ...
                    <div class="rounded-2xl border border-blue-100 bg-blue-50/30 p-5 shadow-sm">
