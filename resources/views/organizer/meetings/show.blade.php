                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <div class="mt-3 grid grid-cols-2 gap-2">
                                            <div class="rounded-xl bg-white p-2.5 shadow-sm">
                                                <p class="text-[9px] font-semibold uppercase tracking-wider text-gray-400">Joined</p>
                                            ...
                                            <div class="rounded-xl bg-white p-2.5 shadow-sm">
                                                <p class="text-[9px] font-semibold uppercase tracking-wider text-gray-400">Left</p>
                                                <p class="mt-1 text-xs font-bold text-gray-700">
