        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 text-xs text-gray-400 mb-1">
                    ...
                    <span>•</span>
                    <span>{{ \Carbon\Carbon::today()->format('l, F d, Y') }}</span>
                </div>
        ...
        <div class="space-y-4">
            ...
            @forelse($todayMeetings as $meeting)
                ...
                @endphp
                    ...
                    <!-- CARD -->
                <div class="group bg-white rounded-2xl p-6 border shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5
                    {{ $isActive ? 'border-l-4 border-l-red-500 border border-gray-200' : 'border-l-4 border-l-blue-500 border border-gray-200' }}">
                    ...
                    <!-- TITLE -->
                    <h2 class="text-xl font-bold text-gray-800 group-hover:text-blue-600 transition">
                        {{ $meeting->title }}
                    </h2>
                    ...
                    <div class="flex items-center justify-between mt-5 pt-4 border-t border-gray-100">
                        ...
                        @else
                            <button disabled
                                    class="bg-gray-100 text-gray-400 px-5 py-2.5 rounded-xl text-sm font-semibold cursor-not-allowed border border-gray-200">
