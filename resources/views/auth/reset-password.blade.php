...
<div class="flex h-full p-10 bg-grey-600">
    ...
    rounded-tl-xl / md / lg / xl / 2xl / full  rounded-bl-xl / md / lg / xl / 2xl / full border-l-8">
        ...
        <div class="mt-10 flex gap-6">
            <div class="relative w-[500px] h-[500px] flex items-center justify-center rounded-lg overflow-hidden">
                <img src="{{ asset('images/reset-password.jpg') }}" class="w-full h-auto object-contain" alt="Login Illustration">

                <!-- Text Overlay -->
                <div class="absolute top-20 left-0 text-left z-10">
                    <h2 class="text-2xl font-bold mb-2">Reset & Go!</h2>
                    <p class="text-gray-600 font-medium font-sm"> Your account is waiting —</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-1/2 flex justify-center items-center bg-blue-50 rounded-tr-xl rounded-br-xl border-r-8">
        <div class="w-[400px] bg-white p-8 rounded-xl shadow-xl">
            <h2 class="text-2xl font-bold mb-4 text-center text-blue-600">Reset Your Password</h2>
            ...
            <form action="{{ route('login') }}" method="get" class="space-y-4">
                <div>
                    ...
                    <input type="password" placeholder="New Password"
                           class="w-full mt-1 p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-200 transition" required>
                </div>
            ...
            <p class="text-center mt-4 text-gray-500">
                <a href="/" class="text-blue-500 text-sm hover:underline">Back to login</a>
            </p>
        </div>
    </div>
